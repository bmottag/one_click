                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form method="POST" id="kt_sign_up_form" action="{{ route('register') }}" class="form w-100">
                            ...
                            <div class="text-center mb-11">
                                <h1 class="text-dark fw-bolder mb-3">Réserver</h1>
                                <div class="text-gray-500 fw-semibold fs-6">Si tu veux réserver, il faut juste remplir le formulaire <br> et verser un acompte de 200$.</div>
                            </div>
                            ...
                            <div id="description_group" class="fv-row mb-8" style="display:none;">
                                ...
                                <textarea class="form-control form-control-solid" rows="6" name="event_description" placeholder="Détails supplémentaires"></textarea>
                            </div>
                            <!-- Note -->
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <div class="fw-semibold">
                                        ...
                                        <div id="note_residential_pack" class="fs-6 text-gray-700 mb-3" style="display:none;">
                                            Pour en savoir plus sur les prix des matériaux, n'hésitez pas à consulter la section Emballage. Vous y trouverez tous les détails utiles.
                                        </div>
                                    </div>
                                </div>
                            </div>
