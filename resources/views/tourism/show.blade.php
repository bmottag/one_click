        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card card-flush mb-9" id="kt_user_profile_panel">
                    ...
                    <x-hero-carousel 
                        :images="[
                            'images/slides/rcw-innovation-investment-opportunities.png',
                            'images/slides/painting-and-remodeling-services.png',
                            'images/slides/luxury-residential-projects.png'
                        ]"
                        height="400"
                    />
                            ...
                            <div class="d-flex flex-stack flex-wrap align-items-end">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">Tourism</a>
                                    </div>
                                    <!--end::Name-->
                                    <!--begin::Text-->
                                    <span class="fw-bold text-gray-600 fs-6 mb-2 d-block">
                                        Browse top tourist attractions, explore destination details, and plan unforgettable experiences during your visit.
                                    </span>
                                    <!--end::Text-->
                                </div>
                                <!--end::User-->
                                <!--begin::Actions-->
                                <div class="d-flex">
                                    <form method="GET" action="{{ route('tourism.show_all') }}">
                                        <!--begin::Card-->
                                        <div class="card mb-7">
                                            <!--begin::Card body-->
                                            <div class="card-body">
                                    ...
                                    <div class="card-body py-9">
                                        ...
                                        <div class="row gx-9 h-100">
                                            ...
                                            <div class="col-sm-6 mb-10 mb-sm-0">
                                                <!--begin::Carousel-->
                                                <div id="eventCarousel{{ $item->id }}" class="carousel slide card-rounded min-h-400px min-h-sm-100 h-100" data-bs-ride="false">
                                                ...
                                                <div class="d-flex flex-column h-100">
                                                    ...
                                                    <div class="mb-7">
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                            <!--begin::Item-->
                                                            <div class="d-flex align-items-center me-5 me-xl-13 gap-2">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        @if(!empty($item->address))
                                                            <!-- Address -->
                                                            <div class="border border-gray-300 border-dashed rounded p-3 d-flex align-items-center gap-2">
