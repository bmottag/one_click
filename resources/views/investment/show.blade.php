                            ...
                            <div class="d-flex flex-stack flex-wrap align-items-end">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">Investment</a>
                                    </div>
                                    <!--end::Name-->
                                    <!--begin::Text-->
                                    <span class="fw-bold text-gray-600 fs-6 mb-2 d-block">
                                        Browse investment opportunities, explore project details, and easily connect with the ones that match your goals.
                                    </span>
                                    <!--end::Text-->
                                </div>
                                <!--end::User-->
                                <!--begin::Actions-->
                                <div class="d-flex">
                                    <form method="GET" action="{{ route('investment.show_all') }}">
                                        <!--begin::Card-->
                                        <div class="card mb-7">
                                            <!--begin::Card body-->
                                            <div class="card-body">
                                    ...
                                    <div class="card-body p-4 d-flex flex-column h-100">
                                        <div class="row gx-4 gx-sm-9 h-100">
                                            ...
                                            <div class="col-sm-6 mb-4 mb-sm-0">
                                                <div id="investmentCarousel{{ $item->id }}" class="carousel slide card-rounded h-100" data-bs-ride="carousel">
                                                    ...
                                                    <!-- Controls -->
                                                    <button class="carousel-control-prev" type="button" data-bs-target="#investmentCarousel{{ $item->id }}" data-bs-slide="prev">
                                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                        <span class="visually-hidden">Previous</span>
                                                    </button>
                                                    <button class="carousel-control-next" type="button" data-bs-target="#investmentCarousel{{ $item->id }}" data-bs-slide="next">
                                                    ...
                                                    <ol class="carousel-indicators">
                                                        @foreach($item->images as $index => $img)
                                                            <li data-bs-target="#investmentCarousel{{ $item->id }}" data-bs-slide-to="{{ $index }}" class="@if($index == 0) active @endif"></li>
                                                        @endforeach
                                                    </ol>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 d-flex flex-column">
                                                ...
                                                <div class="d-flex flex-stack mb-6">
                                                    ...
                                                    <!-- Badge optional -->
                                                    {{-- <span class="badge badge-light-primary py-2 px-3 fs-7">Active</span> --}}
                                                </div>
