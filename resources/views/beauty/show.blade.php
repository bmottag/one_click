...
@section('breadcrumb')
    <x-breadcrumb 
        :items="[
            ...
            ['label' => 'Beauty', 'url' => route('beauty.show_all')],
        ]"
    />
@endsection
                            ...
                            <div class="d-flex flex-stack flex-wrap align-items-end">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">Beauty</a>
                                    </div>
                                    <!--end::Name-->
                                    <!--begin::Text-->
                                    <span class="fw-bold text-gray-600 fs-6 mb-2 d-block">
                                        Browse beauty services, explore details, and easily book or offer the ones that suit you.
                                    </span>
                                    <!--end::Text-->
                                </div>
                                <!--end::User-->
                                <!--begin::Actions-->
                                <div class="d-flex">
                                    <form method="GET" action="{{ route('beauty.show_all') }}">
                                        <!--begin::Card-->
                                        <div class="card mb-7">
                                            <!--begin::Card body-->
                                            <div class="card-body">
                                ...
                                <div class="card card-flush h-100">
                                    ...
                                    <div class="card-body p-4 d-flex flex-column h-100">
                                        ...
                                        <div class="row gx-4 gx-sm-9 h-100">
                                            <!--begin::Image Column-->
                                            <div class="col-sm-6 mb-4 mb-sm-0 d-flex align-items-center justify-content-center">
                                                <img 
