        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Heading-->
                    <h3 class="fw-bold my-2">Beauty</h3>
                    <!--end::Heading-->
                </div>
                            ...
                            <div class="card h-md-100" dir="ltr">
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="text-center mb-1">
                                        <!--begin::Link-->
                                        <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_service">New Beauty</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Links-->
                                </div>
                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    ...
                                    <!--begin::Add product-->
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_service">New Beauty</a>
                                    <!--end::Add product-->
                                </div>
                                <!--end::Card toolbar-->
                            </div>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_service_form" class="form" enctype="multipart/form-data">
                        ...
                        <div class="mb-13 text-center">
                            ...
                            <!--end::Title-->
                            <!--begin::Description-->
                            <div class="text-muted fw-semibold fs-5">Add / Edit Beauty.</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
...
@section('scripts')
    <script src="{{ asset('js/validations/beauty.js') }}"></script>
@endsection
