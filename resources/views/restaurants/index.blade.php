            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="d-flex flex-wrap flex-stack mb-6">
                    ...
                    <div class="d-flex flex-wrap my-2">
                        @if (!$showingAll)
                            <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_new_restaurant">New Restaurant</a>
                        @endif
                    </div>
                    <!--end::Actions-->
                </div>
                ...
                <!--begin::Form-->
                <form method="GET" action="{{ $showingAll ? route('restaurants.show_all') : route('restaurants.index') }}">
                    <!--begin::Card-->
                    <div class="card mb-7">
                        <!--begin::Card body-->
                        <div class="card-body">
