            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="d-flex flex-wrap flex-stack mb-6">
                    ...
                    <div class="d-flex flex-wrap my-2">
                        @if (!$showingAll)
                            <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">New Job</a>
                        @endif
                    </div>
                    <!--end::Actions-->
                </div>
                            ...
                            <div class="card h-md-100" dir="ltr">
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="text-center mb-1">
                                        <!--begin::Link-->
                                        <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">New Job</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Links-->
                                </div>
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                            ...
                                                            <div class="d-flex align-items-center me-5 me-xl-13">
                                                                @if (!empty($job->instagram))
                                                                    @php
                                                                        $igLink = Str::startsWith($job->instagram, ['http://', 'https://']) 
                                                                            ? $job->instagram 
                                                                            : 'https://' . $job->instagram;
                                                                    @endphp
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 mb-3">
                                                                <!--begin::Number-->
                                                                <span class="fs-6 text-gray-700 fw-bold">{{ $job->place }}</span>
                                                                <!--end::Number-->
                                                                <!--begin::Label-->
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" >
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Event Title" name="job_title" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Place" name="job_place" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
