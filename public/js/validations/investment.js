...
var KTModalNewTarget = function () {
				...
				validator.validate().then(function (status) {
					...
					if (status == 'Valid') {
                        ...
                        myDropzone.on("sendingmultiple", function(file, xhr, formData) {
							...
							formData.append("google", form.querySelector('[name="google"]').value);
                        });
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_service');
			...
			form = document.querySelector('#kt_modal_new_service_form');
			submitButton = document.getElementById('kt_modal_new_service_submit');
			cancelButton = document.getElementById('kt_modal_new_service_cancel');
